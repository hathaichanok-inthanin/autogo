...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="card shadow-sm mb-4 border-0">
            <div class="card-body">
                <form action="{{ route('staff.appointments.index') }}" method="GET" id="filterForm">
                    <div class="row g-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('staff.appointments.index') }}" class="btn btn-outline-secondary">ล้าง</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            @forelse($orders as $order)
                                ...
                                {{--  Edit --}}
                                <div class="modal fade" data-bs-backdrop="static" id="edit{{ $order->id }}" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ url('staff/confirm-status') }}/{{ $order->id }}"
