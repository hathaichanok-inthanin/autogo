                ...
                <div class="col-lg-3 col-12">
                    <div class="small-box text-bg-primary">
                        ...
                        <a href="{{ url('admin/reports/sales') }}"
                            ...
                            รายงานยอดขายทั้งหมด <i class="bi bi-link-45deg"></i>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-12">
                    <div class="small-box text-bg-success">
                        ...
                        <a href="{{ url('admin/orders/pending-payment') }}"
                            class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                            รายการรอชำระเงิน <i class="bi bi-link-45deg"></i>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-12">
                    <div class="small-box text-bg-warning">
                        ...
                        <a href="{{ url('admin/appointments') }}"
                            class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                            ตารางนัดหมายติดตั้ง <i class="bi bi-link-45deg"></i>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-12">
                    <div class="small-box text-bg-danger">
                        ...
                        <a href="{{ url('admin/appointments') }}"
                            class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                            สถานะการติดตั้ง <i class="bi bi-link-45deg"></i>
                        </a>
                    </div>
                </div>
            </div>
