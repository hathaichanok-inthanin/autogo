    ...
    <div class="app-content">
        <div class="container-fluid">
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <input type="hidden" name="product_type" value="tire">
                <div class="d-flex justify-content-between align-items-center mb-4 sticky-top bg-light py-2"
                    style="z-index: 99;">
                    <div>
                        <h4 class="fw-bold mb-1">เพิ่มสินค้าใหม่</h4>
                    </div>
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-warning fw-bold px-4">
                            <i class="fa-solid fa-save me-2"></i> บันทึกสินค้า
                        </button>
                    </div>
                </div>
                @php
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="sku" class="form-control"
                                        placeholder="{{ $sku }}" value="{{ $sku }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="card border-0 shadow-sm mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="model_id" id="model_select" disabled>
                        ...
                        <div class="card border-0 shadow-sm mb-3">
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <select class="form-select" name="type_car">
                                                <option selected disabled>-- เลือกประเภทรถยนต์ --</option>
                                ...
                                <div class="mb-3">
                                    <label class="form-label">คุณสมบัติเด่น (เลือกได้มากกว่า 1)</label>
                                    <div class="d-flex flex-wrap gap-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="features[]"
                                                value="Wet">
                                            <label class="form-check-label" for="chkWet">เบรกสั้น (เปียก)</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="features[]"
                                                value="Offroad">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control border-danger" placeholder="0.00"
                                                name="sale_price">
                                ...
                                <div class="row g-3 mt-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="เช่น 2025"
                                            name="year">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">DOT</label>
                                        <input type="text" class="form-control" placeholder="เช่น 1225"
                                            name="dot">
                                    </div>
                                </div>
                            </div>
