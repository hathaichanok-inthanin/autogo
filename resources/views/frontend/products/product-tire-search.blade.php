...
@section('content')
    ...
    <div class="container py-4">
        <section class="search-section mt-5 mb-5">
            ...
            <hr>
            <form class="search-form" action="{{ route('tires.search') }}" method="post" enctype="multipart/form-data">@csrf
        ...
        <h3>ผลการค้นหา : ขนาด {{ $size }}</h3>
        <p class="text-muted">พบสินค้าทั้งหมด {{ $products->count() }} รายการ</p>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <h2 class="fw-bold">{{ $size }} {{ $product->tireSpec->model->model_name }}</h2>
